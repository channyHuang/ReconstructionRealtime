...
private:
    ...
    std::shared_ptr< std::thread > rebuild_thread;
    ...
    //std::lock_guard<std::mutex> termination_flag_locker{ termination_flag_mutex_lock };
    //std::lock_guard<std::mutex> rebuild_ptr_locker{ rebuild_ptr_mutex_lock };
    //std::lock_guard<std::mutex> working_flag_locker{working_flag_mutex};
    //std::lock_guard<std::mutex> search_flag_locker{ search_flag_mutex };
    //std::lock_guard<std::mutex> rebuild_logger_locker{ rebuild_logger_mutex_lock };
    //std::lock_guard<std::mutex> points_deleted_locker{ points_deleted_rebuild_mutex_lock };
