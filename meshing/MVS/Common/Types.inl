...
template <typename TYPE>
bool TImage<TYPE>::Load(const std::string& fileName)
{
	if (Util::getFileExt(fileName) == ".pfm") {
...
template <typename TYPE>
bool TImage<TYPE>::Save(const std::string& fileName) const
{
...
template <typename TYPE>
void TImage<TYPE>::Show(const std::string& winname, int delay, bool bDestroy) const
{
...
template <typename TYPE>
bool SerializeSave(const TYPE& obj, const std::string& fileName, ARCHIVE_TYPE type, unsigned flags=0)
{
...
template <typename TYPE>
bool SerializeLoad(TYPE& obj, const std::string& fileName, ARCHIVE_TYPE type, unsigned flags=0)
{
