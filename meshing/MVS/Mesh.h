...
namespace MVS {
	...
	public:
		...
		bool Save(const std::string& fileName, const cList<std::string>& comments = cList<std::string>(), bool bBinary = true) const;
		static bool Save(const VertexArr& vertices, const std::string& fileName, bool bBinary = true);
	...
	protected:
		...
		//bool SavePLY(const std::string& fileName, const cList<std::string>& comments=cList<std::string>(), bool bBinary=true) const;
