...
inline void fetchCellFacets( const delaunay_t &Tr, const std::vector< facet_t > &hullFacets, const cell_handle_t &cell, const Image &imageData,
...
inline int intersect( const triangle_t &t, const segment_t &s, int coplanar[ 3 ] )
{
...
inline bool intersect( const delaunay_t &Tr, const segment_t &seg, const std::vector< facet_t > &in_facets, std::vector< facet_t > &out_facets,
...
inline bool intersectFace( const delaunay_t &Tr, const segment_t &seg, const std::vector< facet_t > &in_facets, std::vector< facet_t > &out_facets,
                    intersection_t &inter )
{
    int coplanar[ 3 ];
...
inline edge_cap_t freeSpaceSupport( const delaunay_t &Tr, const std::vector< cell_info_t > &infoCells, const cell_handle_t &cell )
{
